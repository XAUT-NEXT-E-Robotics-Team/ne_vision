 ...
 * @LastEditTime: 2026-03-22 23:33:04
 * @FilePath: /ne_vision/ne_serial/include/crc.hpp
...
uint16_t Get_CRC16_Check_Sum(uint8_t *pchMessage, uint32_t dwLength, uint16_t wCRC = 0x0000);
